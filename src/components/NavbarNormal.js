...
import loppisLogga from '../images/loppis-logga.jpg';
      ...
      <Collapse isOpen={isOpen} navbar>
        ...
        <Nav className="NavbarComponentNavbar" navbar>
          <NavItem className="flex1">
            <NavLink href="/" active> <img src={loppisLogga} alt="logga" /> </NavLink>
          </NavItem>           
          <NavItem className="flex2">
            <Link to={'/search'}> <input className="form-control  w-50 mx-auto" placeholder="Sök efter önskad vara" /> </Link> 
          </NavItem>
